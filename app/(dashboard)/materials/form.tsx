...
import { createMaterial, updateMaterial, getMaterial } from '@/lib/api/materials'
...
export default function MaterialForm({ id, onSuccess, onCancel }: MaterialFormProps) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6">
      <h2 className="text-xl font-semibold mb-6">{id ? '編輯物料' : '新增物料'}</h2>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex justify-end space-x-2">
          <button
            type="button"
            onClick={onCancel || (() => router.push('/materials'))}
